...
saveRDS(nucella_xy, "data/shell/shape_out/shell_xy_object.rds")

# Read xy-file
nucella_xy <- readRDS("data/shell/shape_out/shell_xy_object.rds")
...
# Save nucella_xy_adj
saveRDS(nucella_xy_adj, "data/shell/shape_out/shell_xy_adj_object.rds")
...
# Save nucella_coo
saveRDS(nucella_coo, "data/shell/shape_out/shell_coo_object.rds")
...
# Save nucella_coo_pr
saveRDS(nucella_coo_pr, "data/shell/shape_out/shell_coo_pr_object.rds")
...
for(ii in 1:length(nucella_coo_pr)) {
  ...
  png(paste("data/shell/shell_outlines/",img_name,".png",sep=""))
...
nucella_coe <- efourier(nucella_coo_pr, nb.h = 9, norm=F)

# Save nucella_coe
saveRDS(nucella_coe, "data/shell/shape_out/shell_coe_object.rds")
...
# Export first 5 PCs which cover 90% of possible shell shape variance.
nucella_PCs <- data.frame(sample = nucella_fac$sampleID,
                          country = nucella_fac$country,
                          location = nucella_fac$location,
                          year = nucella_fac$year,
                          PC1 = nucella_pca$x[, 1],
                          PC2 = nucella_pca$x[, 2],
                          PC3 = nucella_pca$x[, 3],
                          PC4 = nucella_pca$x[, 4],
